...
def linearduffingvdp(par, t, k, mu, gamma, alpha, beta):
    ...
    dx = p
    dy = q
    dp = mu * (1-x**2)*p - x + k * np.cos(y-x)
    dq = - gamma * q - alpha * y - beta * y**3 + k * np.cos(x-y)
...
# [kchanges]_________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________
# t_step = 0.01
# t_last = 250 # 50h -> 1 point represent 1h
# t = np.arange(0, 5000, t_step)
# keep = int(t_last / t_step)
