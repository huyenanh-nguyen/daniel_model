...
# [Timeseries X and Y]________________________________________________________________________________________________________________________________________________________________________
# xmax = lilie.maximumofplot()[0]
# ymax = lilie.maximumofplot()[1]
# x_amplitude = lilie.find_peaks_max()[0]
# y_amplitude = lilie.find_peaks_max()[1]
# plt.plot(t[-keep:], xsol[-keep:], label = "x")
# plt.plot(t[-keep:], ysol[-keep:], label = "y")
# plt.legend(fontsize = 16, loc = "upper right")
# plt.xlabel("t in s", fontsize = 20)
# plt.ylabel("x/y in a.u.", fontsize = 20)
...
# [Hysterese?]________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________
